        ...
        <div className="reviews-grid">
          <div className="review-card reveal">
            ...
            <div className="review-text">
              "Planned my Tokyo week in an hour. The suggestions were spot on
              and I felt in control the whole time."
            </div>
          ...
          <div className="review-card reveal delay-2">
            <div className="review-stars">★★★★★</div>
            <div className="review-text">
              "Loved the transparency. I knew where recommendations came from
              and could swap things easily."
            </div>
