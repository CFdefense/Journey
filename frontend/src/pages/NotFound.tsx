  ...
  return (
      <div className="lost-tourist-wrapper">
        <div className="lost-tourist-card">
          <img src="./src/assets/car-on-map.jpg" alt="Lost tourist" className="tourist-image" />
          ...
          <div className="lost-tourist-buttons">
            <button className="btn-journey" onClick={() => navigate("/home")}>Start a New Journey</button>
          </div>
        </div>
      </div>
    );
