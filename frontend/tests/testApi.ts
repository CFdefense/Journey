...
async function apiLogin_orig(payload: LoginRequest): Promise<ApiResult<void>> {
    try {
...
/// # Exceptions
/// Never throws an exception
async function apiSignUp_orig(payload: SignUpRequest): Promise<ApiResult<number>> {
    try {
...
/// # Exceptions
/// Never throws an exception
async function apiLogout_orig(): Promise<ApiResult<void>> {
    try {
...
/// # Exceptions
/// Never throws an exception
async function apiValidate_orig(): Promise<ApiResult<void>> {
    try {
...
// Wrapper functions for test compatibility - unwrap ApiResult
export async function apiSignUp(payload) {
	const result = await apiSignUp_orig(payload);
	return result.status;
}
export async function apiLogin(payload) {
	const result = await apiLogin_orig(payload);
	return result.status;
}
export async function apiLogout() {
	const result = await apiLogout_orig();
	return result.status;
}
export async function apiValidate() {
	const result = await apiValidate_orig();
